	...
	private void InicializaComponentes() {
       ...
       // side_pane.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        ind_1Layout.setHorizontalGroup(
            ind_1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 3, Short.MAX_VALUE)
        );
        
        ind_1Layout.setVerticalGroup(
            ind_1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 43, Short.MAX_VALUE)
        );
