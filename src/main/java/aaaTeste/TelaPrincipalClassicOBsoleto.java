...
public class TelaPrincipalClassicOBsoleto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaPrincipalClassicOBsoleto frame = new TelaPrincipalClassicOBsoleto();
	...
	public TelaPrincipalClassicOBsoleto() {
