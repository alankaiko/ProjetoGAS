...
public class detalhesgraficoPaciente extends JDialog {
	...
	public static void main(String[] args) {
		try {
			detalhesgraficoPaciente dialog = new detalhesgraficoPaciente();
	...
	public detalhesgraficoPaciente() {
		...
		LFechar.setIcon(new ImageIcon(detalhesgraficoPaciente.class.getResource("/imagens/icons8-não-22.png")));
