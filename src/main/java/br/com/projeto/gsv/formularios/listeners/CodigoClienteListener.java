...
public class CodigoClienteListener implements ActionListener{
	private CodidoClienteDialog formulario;
	
	public CodigoClienteListener(CodidoClienteDialog formulario) {
