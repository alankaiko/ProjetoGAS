...
import br.com.projeto.gsv.Listeners.ClienteCNPJListener;
import br.com.projeto.gsv.util.ListasUtil;
import br.com.projeto.gsv.util.TransformaDate;

public class FrmIncluirClienteCNPJ extends JDialog {
	private ClienteCNPJListener listener;
	
	public static void main(String[] args) {
		try {
			FrmIncluirClienteCNPJ dialog = new FrmIncluirClienteCNPJ();
	...
	public FrmIncluirClienteCNPJ() {
		CriarTelaGeral();
		DadosCPF();
		InicializaCompomentes();
		listener = new ClienteCNPJListener(this);
	}
	...
	//cria e tela geral onde todos os componentes serao inseridos, é a tela geral do sistema
		...
		public ClienteCNPJListener getListener() {
			return listener;
		}


		public void setListener(ClienteCNPJListener listener) {
