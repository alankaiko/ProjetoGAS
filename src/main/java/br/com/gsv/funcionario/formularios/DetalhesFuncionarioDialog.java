...
import br.com.gsv.funcionario.grafico.DetalhesFuncionarioClassic;
import br.com.gsv.funcionarios.listeners.DetalhesFuncionarioListener;
...
public class DetalhesFuncionarioDialog extends JDialog {
	...
	private JLabel TId, TNome, TCpf, TRg, TLogradouro, TComplemento, TNumero;
