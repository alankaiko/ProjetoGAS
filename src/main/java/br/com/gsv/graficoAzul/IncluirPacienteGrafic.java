...
public class IncluirPacienteGrafic {
	...
	private void CriaTela(){
		...
		this.formulario.setBounds(100, 100, 680, 500);
		...
		this.formulario.getPanel().setBounds(0, 0, 680, 500);
	...
	private void OrganizaTela(){
		...
		this.formulario.getLDocumento().setFont(new Font("Segoe UI", Font.PLAIN, 12));
		...
		this.formulario.getLCep().setFont(new Font("Segoe UI", Font.PLAIN, 12));
		...
		this.formulario.getLEmail().setFont(new Font("Segoe UI", Font.PLAIN, 12));
		...
		this.formulario.getComboConvenio().setFont(new Font("Tahoma", Font.PLAIN, 10));
		this.formulario.getComboConvenio().setBackground(Color.WHITE);
		
		this.formulario.getLDataCad().setText("Data Cadastro");
		this.formulario.getLDataCad().setFont(new Font("Segoe UI", Font.PLAIN, 12));
		
		this.formulario.getJDataCadastro().setEditable(false);
		this.formulario.getJDataCadastro().setFont(new Font("Segoe UI", Font.PLAIN, 11));
		...
		this.formulario.getLConvenio().setFont(new Font("Segoe UI", Font.PLAIN, 12));
		
		this.formulario.getLAdicionaConvenio().setText("Adicionar?");
		this.formulario.getLAdicionaConvenio().setForeground(Color.BLUE);
		this.formulario.getLAdicionaConvenio().setFont(new Font("Segoe UI Light", Font.PLAIN, 10));
		
		this.formulario.getLDataNasc().setText("Data Nascimento");
		this.formulario.getLDataNasc().setFont(new Font("Segoe UI", Font.PLAIN, 12));
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel.createSequentialGroup()
				.addComponent(this.formulario.getLEmail(), GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
				.addGap(290)
				...
				.addGroup(gl_panel.createSequentialGroup()
				.addContainerGap()
				.addComponent(this.formulario.getLContato(), GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
				...
				.addComponent(this.formulario.getLCep(), GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE))
				.addGap(14))
				.addGroup(gl_panel.createSequentialGroup()
				.addContainerGap()
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addComponent(this.formulario.getLDataNasc(), GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
				.addComponent(this.formulario.getJDataNasc(), GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE))
				.addPreferredGap(ComponentPlacement.RELATED, 34, Short.MAX_VALUE)
				.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
				.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addComponent(this.formulario.getLRg(), Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
				.addComponent(this.formulario.getTRg(), Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE))
				.addGap(172)
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
				.addComponent(this.formulario.getComboConvenio(), GroupLayout.PREFERRED_SIZE, 173, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(this.formulario.getLAdicionaConvenio()))
				.addComponent(this.formulario.getLConvenio(), GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE))
				.addGap(39))
				.addGroup(gl_panel.createSequentialGroup()
				...
				.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addComponent(this.formulario.getTNome(), GroupLayout.PREFERRED_SIZE, 476, GroupLayout.PREFERRED_SIZE)
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addComponent(this.formulario.getLDataCad(), GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
				.addComponent(this.formulario.getJDataCadastro(), GroupLayout.PREFERRED_SIZE, 91, GroupLayout.PREFERRED_SIZE))))
				.addGap(14))))
				.addGroup(gl_panel.createSequentialGroup()
				.addContainerGap()
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addComponent(this.formulario.getJCpf(), GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
				.addComponent(this.formulario.getLDocumento(), GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(gl_panel.createSequentialGroup()
				.addGap(245)
				.addComponent(this.formulario.getBTGravar(), GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE)
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addComponent(this.formulario.getJDataCadastro(), GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
				.addGap(8)
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
				.addComponent(this.formulario.getLDocumento(), GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_panel.createSequentialGroup()
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
				.addComponent(this.formulario.getLDataNasc(), GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
				.addComponent(this.formulario.getLConvenio()))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
				.addComponent(this.formulario.getJDataNasc(), GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
				.addComponent(this.formulario.getComboConvenio(), GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
				.addComponent(this.formulario.getLAdicionaConvenio())))
				.addGroup(gl_panel.createSequentialGroup()
				...
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(this.formulario.getLContato(), GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
