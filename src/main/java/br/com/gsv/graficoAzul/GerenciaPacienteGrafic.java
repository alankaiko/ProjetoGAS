...
public class GerenciaPacienteGrafic {
	private GerenciaTelaPaciente formulario;
	
	public GerenciaPacienteGrafic(GerenciaTelaPaciente formulario) {
	...
	private void DadosFuncionario(){
		...
		LFechar.setIcon(new ImageIcon(GerenciaPacienteGrafic.class.getResource("/imagens/icons8-não-22.png")));
