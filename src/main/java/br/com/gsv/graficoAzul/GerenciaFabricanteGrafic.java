...
public class GerenciaFabricanteGrafic {
	private GerenciaTelaFabricante formulario;
	
	public GerenciaFabricanteGrafic(GerenciaTelaFabricante formulario) {
	...
	private void DadosFuncionario(){
		...
		LFechar.setIcon(new ImageIcon(GerenciaFabricanteGrafic.class.getResource("/imagens/icons8-não-22.png")));
