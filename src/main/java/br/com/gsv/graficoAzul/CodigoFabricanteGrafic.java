...
public class CodigoFabricanteGrafic {
	private CodigoFabricanteDialog formulario;
	private FieldListener field = new FieldListener();
	
	
	public CodigoFabricanteGrafic(CodigoFabricanteDialog formulario) {
...
this.formulario.getPainelDrag().setBackground(new Color(20, 34, 56));
		...
		LFechar.setIcon(new ImageIcon(CodigoFabricanteGrafic.class.getResource("/imagens/icons8-não-22.png")));
