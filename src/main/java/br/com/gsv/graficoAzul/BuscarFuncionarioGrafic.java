...
public class BuscarFuncionarioGrafic {
	private BuscarFuncionarioDialog formulario;
	private FieldListener field = new FieldListener();
	
	
	public BuscarFuncionarioGrafic(BuscarFuncionarioDialog formulario) {
	...
	private void CriarTelaGeral() {
		...
		LFechar.setIcon(new ImageIcon(BuscarFuncionarioGrafic.class.getResource("/imagens/icons8-não-22.png")));
