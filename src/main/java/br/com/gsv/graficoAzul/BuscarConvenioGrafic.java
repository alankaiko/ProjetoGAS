...
public class BuscarConvenioGrafic {
	private BuscarConvenioDialog formulario;
	private FieldListener field = new FieldListener();
	
	
	public BuscarConvenioGrafic(BuscarConvenioDialog formulario) {
	...
	private void CriarTelaGeral() {
		...
		LFechar.setIcon(new ImageIcon(BuscarConvenioGrafic.class.getResource("/imagens/icons8-não-22.png")));
		...
		this.formulario.getBuscaNome().setText("Convênio");
