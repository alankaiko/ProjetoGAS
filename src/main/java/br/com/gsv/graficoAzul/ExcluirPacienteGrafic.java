...
public class ExcluirPacienteGrafic {
	private ExcluirPacienteDialog formulario;
	
	
	public ExcluirPacienteGrafic(ExcluirPacienteDialog formulario) {
...
this.formulario.getPainelDrag().setBackground(new Color(20, 34, 56));
		...
		LFechar.setIcon(new ImageIcon(ExcluirPacienteGrafic.class.getResource("/imagens/icons8-não-22.png")));
		...
		this.formulario.getExcluir().setText("Excluir: "+ formulario.getCliente().getNome() + "?");
