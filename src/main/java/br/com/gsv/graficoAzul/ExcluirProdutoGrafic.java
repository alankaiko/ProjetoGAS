...
public class ExcluirProdutoGrafic {
	private ExcluirProdutoDialog formulario;
	
	public ExcluirProdutoGrafic(ExcluirProdutoDialog formulario) {
...
this.formulario.getPainelDrag().setBackground(new Color(20, 34, 56));
		...
		LFechar.setIcon(new ImageIcon(ExcluirProdutoGrafic.class.getResource("/imagens/icons8-não-22.png")));
		...
		this.formulario.getExcluir().setText("Excluir: "+ formulario.getProduto().getDescricao() + "?");
