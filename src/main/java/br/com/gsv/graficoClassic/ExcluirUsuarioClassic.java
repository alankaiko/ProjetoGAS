...
public class ExcluirUsuarioClassic {
	private ExcluirUsuarioDialog formulario;

	public ExcluirUsuarioClassic(ExcluirUsuarioDialog formulario) {
	...
	public void DefineComponentes(){
		this.formulario.getExcluir().setText("Excluir: "+ this.formulario.getUsuario().getLogin() +" ?");
