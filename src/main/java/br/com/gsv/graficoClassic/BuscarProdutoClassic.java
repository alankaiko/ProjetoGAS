...
public class BuscarProdutoClassic {
	private BuscarProdutoDialog formulario;
	
	public BuscarProdutoClassic(BuscarProdutoDialog formulario) {
	...
	public void CriarTelaGeralClassic() {
		this.formulario.setTitle("Buscar Funcionários");
	...
	public void DadosConvenio() {
		...
		this.formulario.getBuscarDescricao().setBounds(15,10,150,20);
		...
		this.formulario.getBuscaDescricao().setBounds(96, 40, 83, 23);
		
		this.formulario.getBuscaFabricante().setText("Fabricante");
		this.formulario.getBuscaFabricante().setFont(new Font("Arial", Font.PLAIN, 13));
		this.formulario.getBuscaFabricante().setBounds(190, 40, 108, 23);
