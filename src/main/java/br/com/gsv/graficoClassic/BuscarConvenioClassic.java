...
public class BuscarConvenioClassic {
	private BuscarConvenioDialog formulario;
	
	public BuscarConvenioClassic(BuscarConvenioDialog formulario) {
	...
	public void OrganizaDados(){
		...
		this.formulario.getBuscaId().setBounds(15, 40, 84, 23);
		
		
		this.formulario.getBuscaNome().setText("Convenio");
