	...
	public void DadosConvenio() {
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.TRAILING)
				...
				.addComponent(this.formulario.getLFabricante(), GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE))
				...
				.addComponent(this.formulario.getTFabricante(), GroupLayout.PREFERRED_SIZE, 171, GroupLayout.PREFERRED_SIZE)
				.addGap(14))))
				.addGroup(gl_panel.createSequentialGroup()
				.addGap(155)
