	...
	public void Dados(){
		...
		this.formulario.getLIndentif().setForeground(Color.black);
			...
			this.formulario.getLDataNasc().setFont(new Font("Arial" , Font.BOLD,11));;
				this.formulario.getTDataNasc().setBounds(111,121,120,19);
				this.formulario.getTDataNasc().setFont(new Font("Arial",Font.BOLD,12));										
			...
			this.formulario.getLDataCad().setFont(new Font("Arial" , Font.BOLD,11));;
				this.formulario.getTDataCadastro().setBounds(525,30,84,19);
				
			this.formulario.getLConvenio().setText("Convênio / Plano / Credencial");
			this.formulario.getLConvenio().setBounds(303, 124, 220, 14);
				this.formulario.getTConvenio().setBounds(478, 121, 133, 20);
